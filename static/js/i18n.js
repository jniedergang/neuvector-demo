...
const translations = {
    en: {
        ...
        'demo.sigstore': 'Image Signature Verification',
        ...
        'sigstore.registryImages': 'Registry Images',
        'sigstore.signed': 'SIGNED',
        'sigstore.notSigned': 'NOT SIGNED',
        'sigstore.deploySigned': 'Deploy Signed',
        'sigstore.deployUnsigned': 'Deploy Unsigned',
        'sigstore.setup': 'Setup Sigstore',
        'sigstore.cleanup': 'Cleanup',
        'sigstore.scan': 'Scan Registry',
        'sigstore.notConfigured': 'Not configured — click Setup',
        'sigstore.noImages': 'No images — click Scan Registry',
        'sigstore.admissionRule': 'Admission Rule',
        'category.DLP': 'DLP',
        ...
        // Kiosk mode
        'kiosk.play': 'Start kiosk mode',
        'kiosk.stop': 'Stop kiosk mode',
        'kiosk.editor': 'Scenario editor',
        'kiosk.step': 'Step',
        'kiosk.noScenario': 'No scenario configured. Open the editor to create one.',
        'kiosk.stepType.select_demo': 'Select demo',
        'kiosk.stepType.set_mode': 'Change mode',
        'kiosk.stepType.run_attack': 'Run attack',
        'kiosk.stepType.show_bubble': 'Show bubble',
        'kiosk.stepType.hide_bubbles': 'Hide bubbles',
        'kiosk.stepType.wait_complete': 'Wait for completion',
        'kiosk.stepType.wait': 'Pause',
        'kiosk.selectSections': 'Select sections to run',
        'kiosk.loopInfinite': 'Loop (restart when done)',
        'kiosk.loopManual': 'Manual (validate each step)',
        'kiosk.sectionIntro': 'Introduction',
        'kiosk.stepType.section': 'Section',
        'kiosk.stepType.reset_platform': 'Reset platform',
        'kiosk.editorTitle': 'Scenario Editor',
        'kiosk.palette': 'Available steps',
        'kiosk.timeline': 'Scenario',
        'kiosk.loadDefault': 'Load default',
        'kiosk.save': 'Save',
        'kiosk.bubble.welcome': 'Welcome! This demo shows how NeuVector protects containers against attacks.',
        'kiosk.bubble.discoverExplain': 'Both pods are in Discover mode — all traffic is allowed and NeuVector learns the normal behavior.',
        'kiosk.bubble.attackSuccess': 'The SCP attack succeeded! Sensitive data (/etc/passwd) was exfiltrated to the target.',
        'kiosk.bubble.switchProtect': 'Let\'s switch the source pod to Protect mode to block unauthorized traffic...',
        'kiosk.bubble.retryAttack': 'Now let\'s retry the same attack...',
        'kiosk.bubble.attackBlocked': 'The attack is blocked! NeuVector intercepts the traffic because there is no allow rule.',
        'kiosk.bubble.floodExplain': 'DoS Ping Flood — sends oversized ICMP packets (40KB) to overwhelm the target and cause a denial of service.',
        'kiosk.bubble.floodSuccess': 'The flood attack succeeded! The target was overwhelmed with ICMP packets.',
        'kiosk.bubble.floodBlocked': 'Blocked! NeuVector enforces network rules and blocks unauthorized ICMP traffic.',
        'kiosk.bubble.scpExplain': 'SCP Transfer — attempts to exfiltrate sensitive data (/etc/passwd) to a remote target via SSH.',
        'kiosk.bubble.scpSuccess': 'Data exfiltration succeeded! /etc/passwd was copied to the target.',
        'kiosk.bubble.scpBlocked': 'Blocked! NeuVector blocks the SCP connection — no allow rule for SSH traffic.',
        'kiosk.bubble.backdoorExplain': 'NC Backdoor — opens a listening port with netcat to create a backdoor into the container.',
        'kiosk.bubble.backdoorSuccess': 'Backdoor active! An attacker could connect to port 4444 and gain shell access.',
        'kiosk.bubble.backdoorBlocked': 'Blocked! NeuVector kills the nc process — it is not in the authorized process profile.',
        'kiosk.bubble.shellExplain': 'Reverse Shell — attempts to establish a reverse shell connection back to an attacker.',
        'kiosk.bubble.shellSuccess': 'Reverse shell established! The attacker has full interactive access to the container.',
        'kiosk.bubble.shellBlocked': 'Blocked! NeuVector kills the unauthorized process before it can connect.',
        'kiosk.bubble.nextAttack': 'Now let\'s try another attack type...',
        'kiosk.bubble.processProtect': 'For process-based attacks, we also need Process Profile in Protect mode...',
        'kiosk.bubble.demoEnd': 'Demo complete! NeuVector protects containers via network policies AND process profiles.',
    ...
    fr: {
        ...
        'sigstore.registryImages': 'Images du registre',
        'sigstore.signed': 'SIGNÉ',
        'sigstore.notSigned': 'NON SIGNÉ',
        'sigstore.deploySigned': 'Déployer signée',
        'sigstore.deployUnsigned': 'Déployer non signée',
        'sigstore.setup': 'Configurer Sigstore',
        'sigstore.cleanup': 'Nettoyer',
        'sigstore.scan': 'Scanner le registre',
        'sigstore.notConfigured': 'Non configuré — cliquez sur Configurer',
        'sigstore.noImages': 'Aucune image — cliquez sur Scanner le registre',
        'sigstore.admissionRule': 'Règle d\'admission',
        'category.DLP': 'DLP',
        'category.Admission': 'Admission',
        ...
        'kiosk.play': 'Lancer le mode kiosk',
        'kiosk.stop': 'Arrêter le mode kiosk',
        'kiosk.editor': 'Éditeur de scénario',
        'kiosk.step': 'Étape',
        'kiosk.noScenario': 'Aucun scénario configuré. Ouvrez l\'éditeur pour en créer un.',
        'kiosk.stepType.select_demo': 'Sélectionner démo',
        'kiosk.stepType.set_mode': 'Changer mode',
        'kiosk.stepType.run_attack': 'Lancer attaque',
        'kiosk.stepType.show_bubble': 'Afficher bulle',
        'kiosk.stepType.hide_bubbles': 'Masquer bulles',
        'kiosk.stepType.wait_complete': 'Attendre la fin',
        'kiosk.stepType.wait': 'Pause',
        'kiosk.selectSections': 'Sélectionner les sections à exécuter',
        'kiosk.loopInfinite': 'Boucle (recommencer à la fin)',
        'kiosk.loopManual': 'Manuel (valider chaque étape)',
        'kiosk.sectionIntro': 'Introduction',
        'kiosk.stepType.section': 'Section',
        'kiosk.stepType.reset_platform': 'Réinitialiser la plateforme',
        'kiosk.editorTitle': 'Éditeur de scénario',
        'kiosk.palette': 'Étapes disponibles',
        'kiosk.timeline': 'Scénario',
        'kiosk.loadDefault': 'Charger défaut',
        'kiosk.save': 'Enregistrer',
        'kiosk.bubble.welcome': 'Bienvenue ! Cette démo montre comment NeuVector protège les conteneurs contre les attaques.',
        'kiosk.bubble.discoverExplain': 'Les deux pods sont en mode Discover — tout le trafic est autorisé et NeuVector apprend le comportement normal.',
        'kiosk.bubble.attackSuccess': 'L\'attaque SCP a réussi ! Des données sensibles (/etc/passwd) ont été exfiltrées vers la cible.',
        'kiosk.bubble.switchProtect': 'Passons le pod source en mode Protect pour bloquer le trafic non autorisé...',
        'kiosk.bubble.retryAttack': 'Maintenant, relançons la même attaque...',
        'kiosk.bubble.attackBlocked': 'L\'attaque est bloquée ! NeuVector intercepte le trafic car il n\'y a pas de règle l\'autorisant.',
        'kiosk.bubble.floodExplain': 'Flood Ping DoS — envoie des paquets ICMP surdimensionnés (40KB) pour saturer la cible et provoquer un déni de service.',
        'kiosk.bubble.floodSuccess': 'Le flood a réussi ! La cible a été saturée de paquets ICMP.',
        'kiosk.bubble.floodBlocked': 'Bloqué ! NeuVector applique les règles réseau et bloque le trafic ICMP non autorisé.',
        'kiosk.bubble.scpExplain': 'Transfert SCP — tente d\'exfiltrer des données sensibles (/etc/passwd) vers une cible distante via SSH.',
        'kiosk.bubble.scpSuccess': 'Exfiltration réussie ! /etc/passwd a été copié vers la cible.',
        'kiosk.bubble.scpBlocked': 'Bloqué ! NeuVector bloque la connexion SCP — pas de règle autorisant le trafic SSH.',
        'kiosk.bubble.backdoorExplain': 'NC Backdoor — ouvre un port d\'écoute avec netcat pour créer une porte dérobée dans le conteneur.',
        'kiosk.bubble.backdoorSuccess': 'Backdoor active ! Un attaquant pourrait se connecter au port 4444 et obtenir un accès shell.',
        'kiosk.bubble.backdoorBlocked': 'Bloqué ! NeuVector tue le processus nc — il n\'est pas dans le profil de processus autorisé.',
        'kiosk.bubble.shellExplain': 'Reverse Shell — tente d\'établir une connexion shell inverse vers un attaquant.',
        'kiosk.bubble.shellSuccess': 'Reverse shell établi ! L\'attaquant a un accès interactif complet au conteneur.',
        'kiosk.bubble.shellBlocked': 'Bloqué ! NeuVector tue le processus non autorisé avant qu\'il ne puisse se connecter.',
        'kiosk.bubble.nextAttack': 'Essayons maintenant un autre type d\'attaque...',
        'kiosk.bubble.processProtect': 'Pour les attaques basées sur les processus, il faut aussi le Process Profile en mode Protect...',
        'kiosk.bubble.demoEnd': 'Démo terminée ! NeuVector protège les conteneurs via les politiques réseau ET les profils de processus.',
    ...
    de: {
        ...
        'sigstore.registryImages': 'Registry-Images',
        'sigstore.signed': 'SIGNIERT',
        'sigstore.notSigned': 'NICHT SIGNIERT',
        'sigstore.deploySigned': 'Signiertes deployen',
        'sigstore.deployUnsigned': 'Nicht signiertes deployen',
        'sigstore.setup': 'Sigstore einrichten',
        'sigstore.cleanup': 'Aufräumen',
        'sigstore.scan': 'Registry scannen',
        'sigstore.notConfigured': 'Nicht konfiguriert — klicken Sie auf Einrichten',
        'sigstore.noImages': 'Keine Images — klicken Sie auf Registry scannen',
        'sigstore.admissionRule': 'Zugangsregel',
        'category.DLP': 'DLP',
        'category.Admission': 'Admission',
        ...
        'kiosk.play': 'Kiosk-Modus starten',
        'kiosk.stop': 'Kiosk-Modus stoppen',
        'kiosk.editor': 'Szenario-Editor',
        'kiosk.step': 'Schritt',
        'kiosk.noScenario': 'Kein Szenario konfiguriert. Öffnen Sie den Editor, um eines zu erstellen.',
        'kiosk.stepType.select_demo': 'Demo auswählen',
        'kiosk.stepType.set_mode': 'Modus ändern',
        'kiosk.stepType.run_attack': 'Angriff starten',
        'kiosk.stepType.show_bubble': 'Blase anzeigen',
        'kiosk.stepType.hide_bubbles': 'Blasen ausblenden',
        'kiosk.stepType.wait_complete': 'Auf Abschluss warten',
        'kiosk.stepType.wait': 'Pause',
        'kiosk.selectSections': 'Abschnitte zum Ausführen auswählen',
        'kiosk.loopInfinite': 'Schleife (am Ende neu starten)',
        'kiosk.loopManual': 'Manuell (jeden Schritt bestätigen)',
        'kiosk.sectionIntro': 'Einleitung',
        'kiosk.stepType.section': 'Abschnitt',
        'kiosk.stepType.reset_platform': 'Plattform zurücksetzen',
        'kiosk.editorTitle': 'Szenario-Editor',
        'kiosk.palette': 'Verfügbare Schritte',
        'kiosk.timeline': 'Szenario',
        'kiosk.loadDefault': 'Standard laden',
        'kiosk.save': 'Speichern',
        'kiosk.bubble.welcome': 'Willkommen! Diese Demo zeigt, wie NeuVector Container vor Angriffen schützt.',
        'kiosk.bubble.discoverExplain': 'Beide Pods sind im Discover-Modus — der gesamte Verkehr ist erlaubt und NeuVector lernt das normale Verhalten.',
        'kiosk.bubble.attackSuccess': 'Der SCP-Angriff war erfolgreich! Sensible Daten (/etc/passwd) wurden zum Ziel exfiltriert.',
        'kiosk.bubble.switchProtect': 'Schalten wir den Quell-Pod in den Protect-Modus, um nicht autorisierten Verkehr zu blockieren...',
        'kiosk.bubble.retryAttack': 'Versuchen wir jetzt den gleichen Angriff erneut...',
        'kiosk.bubble.attackBlocked': 'Der Angriff ist blockiert! NeuVector fängt den Verkehr ab, da keine Erlaubnisregel existiert.',
        'kiosk.bubble.floodExplain': 'DoS-Ping-Flood — sendet übergroße ICMP-Pakete (40KB), um das Ziel zu überfluten und einen Denial-of-Service zu verursachen.',
        'kiosk.bubble.floodSuccess': 'Der Flood-Angriff war erfolgreich! Das Ziel wurde mit ICMP-Paketen überflutet.',
        'kiosk.bubble.floodBlocked': 'Blockiert! NeuVector erzwingt Netzwerkregeln und blockiert nicht autorisierten ICMP-Verkehr.',
        'kiosk.bubble.scpExplain': 'SCP-Transfer — versucht, sensible Daten (/etc/passwd) über SSH an ein Remote-Ziel zu exfiltrieren.',
        'kiosk.bubble.scpSuccess': 'Datenexfiltration erfolgreich! /etc/passwd wurde zum Ziel kopiert.',
        'kiosk.bubble.scpBlocked': 'Blockiert! NeuVector blockiert die SCP-Verbindung — keine Erlaubnisregel für SSH-Verkehr.',
        'kiosk.bubble.backdoorExplain': 'NC Backdoor — öffnet einen Listening-Port mit Netcat, um eine Hintertür im Container zu erstellen.',
        'kiosk.bubble.backdoorSuccess': 'Backdoor aktiv! Ein Angreifer könnte sich mit Port 4444 verbinden und Shell-Zugriff erhalten.',
        'kiosk.bubble.backdoorBlocked': 'Blockiert! NeuVector beendet den nc-Prozess — er ist nicht im autorisierten Prozessprofil.',
        'kiosk.bubble.shellExplain': 'Reverse Shell — versucht, eine umgekehrte Shell-Verbindung zu einem Angreifer herzustellen.',
        'kiosk.bubble.shellSuccess': 'Reverse Shell hergestellt! Der Angreifer hat vollen interaktiven Zugriff auf den Container.',
        'kiosk.bubble.shellBlocked': 'Blockiert! NeuVector beendet den nicht autorisierten Prozess, bevor er sich verbinden kann.',
        'kiosk.bubble.nextAttack': 'Versuchen wir jetzt einen anderen Angriffstyp...',
        'kiosk.bubble.processProtect': 'Für prozessbasierte Angriffe brauchen wir auch das Prozessprofil im Protect-Modus...',
        'kiosk.bubble.demoEnd': 'Demo abgeschlossen! NeuVector schützt Container über Netzwerkrichtlinien UND Prozessprofile.',
    ...
    es: {
        ...
        'sigstore.registryImages': 'Imágenes del registro',
        'sigstore.signed': 'FIRMADO',
        'sigstore.notSigned': 'NO FIRMADO',
        'sigstore.deploySigned': 'Desplegar firmada',
        'sigstore.deployUnsigned': 'Desplegar no firmada',
        'sigstore.setup': 'Configurar Sigstore',
        'sigstore.cleanup': 'Limpiar',
        'sigstore.scan': 'Escanear registro',
        'sigstore.notConfigured': 'No configurado — haga clic en Configurar',
        'sigstore.noImages': 'Sin imágenes — haga clic en Escanear registro',
        'sigstore.admissionRule': 'Regla de admisión',
        'category.DLP': 'DLP',
        ...
        'kiosk.play': 'Iniciar modo kiosk',
        'kiosk.stop': 'Detener modo kiosk',
        'kiosk.editor': 'Editor de escenario',
        'kiosk.step': 'Paso',
        'kiosk.noScenario': 'No hay escenario configurado. Abra el editor para crear uno.',
        'kiosk.stepType.select_demo': 'Seleccionar demo',
        'kiosk.stepType.set_mode': 'Cambiar modo',
        'kiosk.stepType.run_attack': 'Ejecutar ataque',
        'kiosk.stepType.show_bubble': 'Mostrar burbuja',
        'kiosk.stepType.hide_bubbles': 'Ocultar burbujas',
        'kiosk.stepType.wait_complete': 'Esperar finalización',
        'kiosk.stepType.wait': 'Pausa',
        'kiosk.selectSections': 'Seleccionar secciones a ejecutar',
        'kiosk.loopInfinite': 'Bucle (reiniciar al terminar)',
        'kiosk.loopManual': 'Manual (validar cada paso)',
        'kiosk.sectionIntro': 'Introducción',
        'kiosk.stepType.section': 'Sección',
        'kiosk.stepType.reset_platform': 'Reiniciar plataforma',
        'kiosk.editorTitle': 'Editor de escenario',
        'kiosk.palette': 'Pasos disponibles',
        'kiosk.timeline': 'Escenario',
        'kiosk.loadDefault': 'Cargar predeterminado',
        'kiosk.save': 'Guardar',
        'kiosk.bubble.welcome': '¡Bienvenido! Esta demo muestra cómo NeuVector protege los contenedores contra ataques.',
        'kiosk.bubble.discoverExplain': 'Ambos pods están en modo Discover — todo el tráfico está permitido y NeuVector aprende el comportamiento normal.',
        'kiosk.bubble.attackSuccess': '¡El ataque SCP tuvo éxito! Se exfiltraron datos sensibles (/etc/passwd) hacia el destino.',
        'kiosk.bubble.switchProtect': 'Cambiemos el pod de origen a modo Protect para bloquear el tráfico no autorizado...',
        'kiosk.bubble.retryAttack': 'Ahora intentemos el mismo ataque de nuevo...',
        'kiosk.bubble.attackBlocked': '¡El ataque está bloqueado! NeuVector intercepta el tráfico porque no hay una regla que lo permita.',
        'kiosk.bubble.floodExplain': 'Inundación Ping DoS — envía paquetes ICMP sobredimensionados (40KB) para saturar el objetivo y causar una denegación de servicio.',
        'kiosk.bubble.floodSuccess': '¡El ataque de inundación tuvo éxito! El objetivo fue saturado con paquetes ICMP.',
        'kiosk.bubble.floodBlocked': '¡Bloqueado! NeuVector aplica reglas de red y bloquea el tráfico ICMP no autorizado.',
        'kiosk.bubble.scpExplain': 'Transferencia SCP — intenta exfiltrar datos sensibles (/etc/passwd) a un objetivo remoto vía SSH.',
        'kiosk.bubble.scpSuccess': '¡Exfiltración exitosa! /etc/passwd fue copiado al objetivo.',
        'kiosk.bubble.scpBlocked': '¡Bloqueado! NeuVector bloquea la conexión SCP — no hay regla que permita tráfico SSH.',
        'kiosk.bubble.backdoorExplain': 'NC Backdoor — abre un puerto de escucha con netcat para crear una puerta trasera en el contenedor.',
        'kiosk.bubble.backdoorSuccess': '¡Puerta trasera activa! Un atacante podría conectarse al puerto 4444 y obtener acceso shell.',
        'kiosk.bubble.backdoorBlocked': '¡Bloqueado! NeuVector mata el proceso nc — no está en el perfil de procesos autorizado.',
        'kiosk.bubble.shellExplain': 'Reverse Shell — intenta establecer una conexión shell inversa hacia un atacante.',
        'kiosk.bubble.shellSuccess': '¡Reverse shell establecido! El atacante tiene acceso interactivo completo al contenedor.',
        'kiosk.bubble.shellBlocked': '¡Bloqueado! NeuVector mata el proceso no autorizado antes de que pueda conectarse.',
        'kiosk.bubble.nextAttack': 'Ahora intentemos otro tipo de ataque...',
        'kiosk.bubble.processProtect': 'Para ataques basados en procesos, también necesitamos el Perfil de Proceso en modo Protect...',
        'kiosk.bubble.demoEnd': '¡Demo completada! NeuVector protege contenedores vía políticas de red Y perfiles de proceso.',
