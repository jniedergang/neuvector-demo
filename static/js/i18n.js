...
const translations = {
    en: {
        ...
        'kiosk.bubble.attackBlocked': 'The attack is blocked! NeuVector intercepts the traffic because there is no allow rule for SCP.',
        'kiosk.bubble.demoEnd': 'Demo complete. NeuVector effectively protects containers by enforcing network policies.',
    ...
    fr: {
        ...
        'kiosk.bubble.attackBlocked': 'L\'attaque est bloquée ! NeuVector intercepte le trafic car il n\'y a pas de règle autorisant SCP.',
        'kiosk.bubble.demoEnd': 'Démo terminée. NeuVector protège efficacement les conteneurs en appliquant les politiques réseau.',
    ...
    de: {
        ...
        'kiosk.bubble.attackBlocked': 'Der Angriff ist blockiert! NeuVector fängt den Verkehr ab, da keine Erlaubnisregel für SCP existiert.',
        'kiosk.bubble.demoEnd': 'Demo abgeschlossen. NeuVector schützt Container effektiv durch die Durchsetzung von Netzwerkrichtlinien.',
    ...
    es: {
        ...
        'kiosk.bubble.attackBlocked': '¡El ataque está bloqueado! NeuVector intercepta el tráfico porque no hay una regla que permita SCP.',
        'kiosk.bubble.demoEnd': 'Demo completada. NeuVector protege eficazmente los contenedores aplicando políticas de red.',
